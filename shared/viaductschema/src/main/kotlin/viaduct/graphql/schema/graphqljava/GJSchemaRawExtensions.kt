...
val SchemaWithData.Def.gjrDef: NamedNode<*>
    get() = when (val d = data) {
...
val SchemaWithData.Directive.gjrDef: DirectiveDefinition
...
val SchemaWithData.Scalar.gjrDef: ScalarTypeDefinition
    get() = (data as TypeDefData<*, *>).def as ScalarTypeDefinition

/** The graphql-java extension definitions for this scalar. */
val SchemaWithData.Scalar.gjrExtensionDefs: List<ScalarTypeExtensionDefinition>
...
val SchemaWithData.Enum.gjrDef: EnumTypeDefinition
    get() = (data as TypeDefData<*, *>).def as EnumTypeDefinition

/** The graphql-java extension definitions for this enum. */
val SchemaWithData.Enum.gjrExtensionDefs: List<EnumTypeExtensionDefinition>
    @Suppress("UNCHECKED_CAST")
...
val SchemaWithData.Union.gjrDef: UnionTypeDefinition
    get() = (data as TypeDefData<*, *>).def as UnionTypeDefinition

/** The graphql-java extension definitions for this union. */
val SchemaWithData.Union.gjrExtensionDefs: List<UnionTypeExtensionDefinition>
    @Suppress("UNCHECKED_CAST")
...
val SchemaWithData.Interface.gjrDef: InterfaceTypeDefinition
    get() = (data as TypeDefData<*, *>).def as InterfaceTypeDefinition

/** The graphql-java extension definitions for this interface. */
val SchemaWithData.Interface.gjrExtensionDefs: List<InterfaceTypeExtensionDefinition>
    @Suppress("UNCHECKED_CAST")
...
val SchemaWithData.Object.gjrExtensionDefs: List<ObjectTypeExtensionDefinition>
    @Suppress("UNCHECKED_CAST")
...
val SchemaWithData.Input.gjrDef: InputObjectTypeDefinition
    get() = (data as TypeDefData<*, *>).def as InputObjectTypeDefinition

/** The graphql-java extension definitions for this input. */
val SchemaWithData.Input.gjrExtensionDefs: List<InputObjectTypeExtensionDefinition>
    @Suppress("UNCHECKED_CAST")
...
val SchemaWithData.EnumValue.gjrDef: EnumValueDefinition
